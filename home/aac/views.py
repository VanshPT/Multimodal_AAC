...
def partner_message_api(request):
    ...
    try:
        ...
        try:
            hr_val = float(hr) if hr not in (None, "", "null") else None
        ...
        response = handle_partner_message(
            ...
            gesture=payload.get("gesture") or None,
            heart_rate_bpm=hr_val,
            gaze_region=payload.get("gaze_region") or None,
            vocal_polarity=payload.get("vocal_polarity") or None,
            air_sign_letter=payload.get("air_sign_letter") or None,
            facial_emotion=payload.get("facial_emotion") or None,
        )
